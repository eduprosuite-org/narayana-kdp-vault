...
\begin{enumerate}[label=(\alph*)]
  \item Determine the outlier boundary fences using the $1.5 \times \text{IQR}$ rule. Is the maximum finish time of 82.0 minutes a confirmed outlier? Justify your answer.
  \item A competitor, Alice, finished the race in 42.0 minutes. Calculate Alice's $z$-score and interpret this value in context.
...
\begin{itemize}[leftmargin=1.2em]
  ...
  Because the maximum time $82.0\text{ minutes} > 77.5\text{ minutes}$, 82.0 minutes is a confirmed high outlier.
  \item \textbf{Part (b):} $z = \frac{x - \bar{x}}{s} = \frac{42.0 - 53.5}{9.2} = \frac{-11.5}{9.2} \approx -1.25$.\\
  ...
  \item \textbf{Part (c):} Let $Y = 60(X - 2) = 60X - 120$ seconds.\\
  ...
  \textit{Spread (SD):} $s_y = 60(s_x) = 60(9.2) = 552\text{ seconds}$. Spread scales strictly by multiplication by $|60|$; subtracting 2 has zero effect on spread.\\
