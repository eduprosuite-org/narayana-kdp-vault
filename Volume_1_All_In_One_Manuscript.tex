...
% OFFICIAL EXAM BLUEPRINT & SYLLABUS WEIGHTAGE
\chapter*{Official AP\textregistered\ Statistics Exam Blueprint \& Unit Weightages}
\addcontentsline{toc}{chapter}{Official AP Exam Blueprint \& Unit Weightages}

Understanding the exact exam structure, pacing requirements, and syllabus weightages ensures you invest your study hours into the highest-yield topics.

\section*{1. Exam Format, Duration \& Pacing Strategy}
...
\section*{3. College Board Calculator \& Formula Rules}
\begin{itemize}[leftmargin=*]
    \item \textbf{Graphing Calculator Policy:} A graphing calculator with standard statistical capabilities (e.g., TI-84 Plus CE, TI-Nspire) is permitted throughout the entire 3-hour exam (both Section I and Section II).
    \item \textbf{Formula Reference Sheet:} The official College Board formula reference sheet and standard normal ($z$), $t$, and $\chi^2$ distribution tables are provided during the test.
    \item \textbf{Avoid Calculator Speak on FRQs:} Never write calculator commands alone (e.g., \texttt{1-PropZTest(0.5, 30, 50)}). Graders require stating the named procedure, null and alternative hypotheses, condition checks, test statistic value, degrees of freedom, and $p$-value in context.
\end{itemize}
